...
public class GameContainer extends JPanel {
    ...
    public GameContainer(String playerName, String cpuDifficulty) {
        ...
        pawnControlArea.setBounds(PAWN_CONTROL_AREA_BOUNDS); // Tamanho e posição da área do controle dos peões (0, 0) ()
        pawnControlArea.setBackground(new Color(18, 50, 25)); // Tom amadeirado escuro
        pawnControlArea.setLayout(null);

        // Instancia o "PawnControlContainer" que irá
        PawnControlContainer pawnControlContainer = new PawnControlContainer();
